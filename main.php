...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="logo.png" alt="EA C4FM Spain">
        </a>
...
<div class="container-fluid px-3 px-lg-4">
    <div class="page-header">
        <h1 class="page-title">Ultimos Escuchados</h1>
...
function getCountryFlag($call) {
    $prefixes = [
        ...
        'UA' => 'ru', 'RU' => 'ru', 'RA' => 'ru', 'RV' => 'ru', 'RW' => 'ru', 'RX' => 'ru', 'RZ' => 'ru', 'BM' => 'ru', 'YC' => 'de'
...
while ($row = $res->fetchArray()) {
    ...
    $osm = !empty($row['latitude']) ? "<a href='https://www.openstreetmap.org/?mlat={$row['latitude']}&mlon={$row['longitude']}' target='_blank' class='btn-map'><img src='map.png' alt='map' style='width:26px; vertical-align:middle;'> GPS</a>" : "";
...
while ($row = $res->fetchArray()) {
    ...
    $flag = getCountryFlag($row['call']);
    $flagHtml = $flag ? "<img class='flag-icon' src='https://flagcdn.com/w40/{$flag}.png' alt='{$flag}'>" : "";
    $osm = !empty($row['latitude']) ? "<a href='https://www.openstreetmap.org/?mlat={$row['latitude']}&mlon={$row['longitude']}' target='_blank' class='btn-map'><img src='map.png' alt='map'> GPS</a>" : "";
